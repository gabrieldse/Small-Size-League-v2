...
def main():
    ...
    try:
        ...
        print(
            "ERRO: Não foi possível inicializar os componentes. Verifique a porta do rádio."
        )
        print(f"Detalhe: {e}")
        return
    ...
    try:
        while True:
            ...
            robot_data = {
                ...
                "robot_target_orientation": math.atan2(
                    POSICAO_BOLA_FALSA["y"], POSICAO_BOLA_FALSA["x"]
                ),
            }
            ...
            sender.send_command(
                ...
                wheel_speeds["bl_direction"],  # M3 -> BR
                wheel_speeds["br_speed"],
                wheel_speeds["br_direction"],  # M4 -> BL
                False,  # Kicker
            )
